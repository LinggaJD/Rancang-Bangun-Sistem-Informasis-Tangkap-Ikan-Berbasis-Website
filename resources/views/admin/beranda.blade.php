...
@php
$jml_user_pengepul = DB::table('users')
->leftJoin('role_user','users.id','role_user.user_id')
->leftJoin('role','role_user.role_id','role.id')
->where('role.role', 'user')
->count();
$jml_data_tangkapan = DB::table('penangkapan')->count();

$jml_data_laporan = DB::table('laporan')->count();
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jml_user_pengepul }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jml_data_tangkapan }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $jml_data_laporan }}</div>
                    </div>
                    <div class="col-auto">
...
<div class="row mb-2">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h1 class="text-center d-block mx-auto bg-secondary text-white p-3 mb-5" style="width:  500px !important; border-radius: 50px !important;">Pengumuman</h1>
